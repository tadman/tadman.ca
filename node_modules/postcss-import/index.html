...
<span class="k">@import</span> <span class="s2">'baz.css'</span> <span class="n">layer</span><span class="p">(</span><span class="n">baz-layer</span><span class="p">);</span>
...
<span class="k">@layer</span> <span class="n">baz-layer</span> <span class="p">{</span>
<span class="c">/* ... content of css/baz.css */</span>
<span class="p">}</span>
...
<h4 id="namelayer"><code class="language-plaintext highlighter-rouge">nameLayer</code></h4>

<p>Type: <code class="language-plaintext highlighter-rouge">Function</code>
Default: <code class="language-plaintext highlighter-rouge">null</code></p>

<p>You can provide a custom naming function for anonymous layers (<code class="language-plaintext highlighter-rouge">@import 'baz.css' layer;</code>).
This function gets <code class="language-plaintext highlighter-rouge">(index, rootFilename)</code> arguments and should return a unique string.</p>
...
<h2 id="license"><a href="/node_modules/postcss-import/LICENSE">License</a></h2>
